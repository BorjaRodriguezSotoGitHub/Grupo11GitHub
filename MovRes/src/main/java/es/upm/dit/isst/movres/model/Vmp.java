...
public class Vmp {
    ...
    public Vmp(Double latitude, Double longitude, Boolean locked, Boolean inUse, Boolean inRep,
            Boolean isBike, Double discount) {
    ...
    public String toString() {
        return "Vmp [discount=" + discount + ", id=" + id + ", inRep=" + inRep + ", inUse=" + inUse + ", isBike="
                + isBike + ", latitude=" + latitude + ", locked=" + locked + ", longitude=" + longitude + "]";
    }
